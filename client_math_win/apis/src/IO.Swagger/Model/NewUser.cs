...
namespace IO.Swagger.Model
{
    ...
    public partial class NewUser :  IEquatable<NewUser>, IValidatableObject
    {
        ...
        /// <param name="pwd">pwd (required).</param>
        /// <param name="roleId">roleId.</param>
        public NewUser(string name = default(string), string pwd = default(string), Guid? roleId = default(Guid?))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for NewUser and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (pwd == null)
            {
                throw new InvalidDataException("pwd is a required property for NewUser and cannot be null");
            }
            else
            {
                this.Pwd = pwd;
