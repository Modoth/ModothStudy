...
f()`;
  ...
  onFocusChanged(focus) {
    if (focus) {
      this.hostRef.nativeElement.scrollTo({ top: this.hostRef.nativeElement.scrollHeight });
      console.log(`${this.hostRef.nativeElement.scrollHeight} ${this.hostRef.nativeElement.scrollTop}`);
    }
  }
}
