...
import { UndoOutlined, ExpandOutlined, CloseOutlined, MobileOutlined, TabletOutlined, CheckOutlined, RotateRightOutlined, RotateLeftOutlined, BorderOutlined } from '@ant-design/icons'
...
export default class ImageEditor extends React.Component<ImageEditorProperties, ImageEditorState> {
  ...
  render () {
    return <div className={classNames('image-editor', this.props.className)}>
  ...
  private tryLoadImage () {
    ...
    public async apply () {
      ...
      if (this.props.maxImageSize && blob.size > this.props.maxImageSize) {
        this.props.onError && this.props.onError(Configs.ServiceMessagesEnum.FileToLarge.toString())
        return
      }
